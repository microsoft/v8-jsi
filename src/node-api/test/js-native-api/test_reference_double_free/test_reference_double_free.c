...
// This is analogous to the test
// https://github.com/nodejs/node-addon-api/blob/main/test/objectwrap_constructor_exception.cc.
// In which the Napi::ObjectWrap<> is being destructed immediately after
// napi_wrap. As Napi::ObjectWrap<> is a subclass of Napi::Reference<>,
// napi_remove_wrap in the destructor of Napi::ObjectWrap<> is called before
// napi_delete_reference in the destructor of Napi::Reference<>.
