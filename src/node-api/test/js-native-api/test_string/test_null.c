...
#define DECLARE_TEST(charset, str_arg)                                         \
  static napi_value test_create_##charset(napi_env env,                        \
    ...
    add_returned_status(env,                                                   \
                        ...
                        "Invalid argument",                                    \
                        napi_invalid_arg,                                      \
                        napi_create_string_##charset(                          \
                            NULL, (str_arg), NAPI_AUTO_LENGTH, &result));      \
                                                                               \
...
static const char16_t something[] = {(char16_t)'s',
                                     (char16_t)'o',
                                     (char16_t)'m',
                                     (char16_t)'e',
                                     (char16_t)'t',
