...
namespace v8runtime {
  ...
  __attribute__((visibility("default")))  std::unique_ptr<jsi::Runtime> makeV8Runtime(
  ...
  __attribute__((visibility("default"))) std::unique_ptr<jsi::Runtime> makeV8Runtime(const std::string& cacheDir, const std::shared_ptr<Logger>& logger);
